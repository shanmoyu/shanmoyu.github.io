...
前面还有一个数据库操作和视图案例在[这里 ](/2025/05/26/hyperf/)（链接放这里，就不合并文档了）
...
**启动容器**
 ...
 1. 拉取镜像，挂载宿主机目录到容器，开放端口 `9501`
    ...
    {% note color:yellow  这里用的官方文档里的&nbsp;hyperf/hyperf:8.1-alpine-v3.18-swoole&nbsp;镜像版本，可以根据自己的需要进行修改。 %}
...
{% note color:yellow  该组件升级自&nbsp;hyperf-ext，改为&nbsp;hyperf-extension&nbsp;支持hyperf3.0+版本。项目地址：https://github.com/hyperf-extension/jwt %}
